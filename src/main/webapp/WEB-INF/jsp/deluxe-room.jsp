    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-8 col-lg-6">
          <div class="room-type">
            <div class="price-line">STAY FROM <span>$100.00</span></div>
            <!-- end price-line -->
            <h3>Deluxe Room</h3>
        ...
        <div class="col-12">
          <div class="room-gallery-top">
            <div class="swiper-wrapper">
              <div class="swiper-slide"> <a href="_frontend/images/room-gallery01.jpg" data-fancybox><img src="_frontend/images/room-gallery01.jpg" alt="Image"></a> </div>
              <!-- end swiper-slide -->
              <div class="swiper-slide"> <a href="_frontend/images/room-gallery02.jpg" data-fancybox><img src="_frontend/images/room-gallery02.jpg" alt="Image"></a> </div>
              <!-- end swiper-slide -->
              <div class="swiper-slide"> <a href="_frontend/images/room-gallery03.jpg" data-fancybox><img src="_frontend/images/room-gallery03.jpg" alt="Image"></a> </div>
              <!-- end swiper-slide -->
              <div class="swiper-slide"> <a href="_frontend/images/room-gallery04.jpg" data-fancybox><img src="_frontend/images/room-gallery04.jpg" alt="Image"></a> </div>
              <!-- end swiper-slide -->
              <div class="swiper-slide"> <a href="_frontend/images/room-gallery05.jpg" data-fancybox><img src="_frontend/images/room-gallery05.jpg" alt="Image"></a> </div>
              <!-- end swiper-slide -->
              <div class="swiper-slide"> <a href="_frontend/images/room-gallery06.jpg" data-fancybox><img src="_frontend/images/room-gallery06.jpg" alt="Image"></a> </div>
              <!-- end swiper-slide -->
          ...
          <div class="room-gallery-thumbs">
            <div class="swiper-wrapper">
              <div class="swiper-slide"><img src="_frontend/images/room-gallery01.jpg" alt="Image"> </div>
              <!-- end swiper-slide -->
              <div class="swiper-slide"><img src="_frontend/images/room-gallery02.jpg" alt="Image"> </div>
              <!-- end swiper-slide -->
              <div class="swiper-slide"><img src="_frontend/images/room-gallery03.jpg" alt="Image"> </div>
              <!-- end swiper-slide -->
              <div class="swiper-slide"><img src="_frontend/images/room-gallery04.jpg" alt="Image"> </div>
              <!-- end swiper-slide -->
              <div class="swiper-slide"><img src="_frontend/images/room-gallery05.jpg" alt="Image"> </div>
              <!-- end swiper-slide -->
              <div class="swiper-slide"><img src="_frontend/images/room-gallery06.jpg" alt="Image"> </div>
              <!-- end swiper-slide -->
