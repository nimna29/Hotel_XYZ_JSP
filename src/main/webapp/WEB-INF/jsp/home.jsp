                ...
                <div class="col-12">
                    <div class="hotel-search">
                        ...
                        <div class="containe">
                            ...
                            <div class="content">
                                <form method="GET" name="bookNowForm" action="<c:url value="roombookingform"/>">
                                    <div class="user-details">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <input name="rooms" type="number" min = 1 placeholder="Enter number of rooms" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details" style='color:white;'>No. Of Children</span>
                                            <input name="pax_child" type="number" min = 0 placeholder="Enter number of children" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details" style='color:white;'>No. Of Adults</span>
                                            <input name="pax_adult" type="number" min = 1 placeholder="Enter number of adults" required>
                                        </div>
                                        <div class="input-box">
